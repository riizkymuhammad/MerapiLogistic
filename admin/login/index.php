...
<head>
    ...
    <title>Merapi Logistic Admin Login</title>
    <!-- Favicon-->
...
<body class="login-page">
    <div class="login-box">
        <div class="logo">
            <a href="javascript:void(0);"><b>ADMIN Merapi Logistik</b></a>
            <small>Merapi Logistik - Khusus administrator</small>
        </div>
        <div class="card">
            <div class="body">
                ...
                if(isset($login)){
                    ...
                    if(mysqli_num_rows(mysqli_query($con,"select idlog from logadmin where username='$username' and password='$password'")))
                    {
                      $tipe=mysqli_fetch_row(mysqli_query($con,"select idlog  from logadmin where username='$username' and password='$password'"));
                ...
                <form id="sign_in" action="" method="POST">
                    <div class="msg">Login khusus administrator</div>
