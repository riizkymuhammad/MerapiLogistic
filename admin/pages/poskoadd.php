                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        if(isset($_POST['simpan']))
                            {
                               $getId=mysqli_fetch_row(mysqli_query($con,"select max(idlog) from logposko")); 
                                ...
                                mysqli_query($con,"insert into logposko values('','$nama','$email','$username','".md5($password)."','".($getId[0]+1).$ext."')");
                                
                                echo "
                                <script>
                                location.assign('index.php?halaman=add-posko&pesan=true');
                                </script>
                                ";
                            }
                                if(isset($_GET['pesan'])=='true')
                                echo "<div class='alert alert-success' role='alert'>Posko telah ditambah</div>";
                            ?>
                        <!--END Proses Update-->
                            ...
                            <!--Proses Tampil-->
                                ...
                                <br>
                                <input type="submit" class="btn btn-primary m-t-15 waves-effect" name="simpan" value="Tambah Posko">
                                <!--END Proses Tampil-->
                            </form>
                        </div>
                    </div>
